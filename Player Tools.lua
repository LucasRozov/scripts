...
function main()
	...
	autoupdate("https://raw.githubusercontent.com/LucasRozov/scripts/main/upd.json", '['..string.upper(thisScript().name)..']: ', "https://raw.githubusercontent.com/LucasRozov/scripts/main/Player%20Tools.lua")
